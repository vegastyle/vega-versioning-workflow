...
- tailscale authentication to use oauth and client secrets


## [1.4.2] - 2026/04/18 08:08:41

### Changed

- vega-packaging to version 0.7.2 to resolve incorrect env values for BUILD


## [1.4.1] - 2026/04/18 07:41:13


## [1.4.0] - 2026/02/26 13:10:18

### Changed

- the workflow to get all the commits from a single push rather than just the latest commit on a push.
